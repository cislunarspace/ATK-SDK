...
# Prefer Ubuntu/driver GLVND libraries before ATK's bundled old libGL.so.1.
# ATK's own libraries still remain available after the system GL paths.
export LD_LIBRARY_PATH="${SYSTEM_GL_PATHS}:${ATK_HOME}:${ATK_HOME}/../lib${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}"
